...
public partial class SoundManager : antilunchbox.Singleton<SoundManager> {
    ...
    private GameObject AddOwnedSFXObject(AudioClip clip) {
        ...
        // Note: DontDestroyOnLoad is not needed as all SFXObjects are children of SoundManager which itself is a child of
        // of my own SFXManager which is persistent across scenes        //GameObject.DontDestroyOnLoad(SFXObject);  
