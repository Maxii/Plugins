...
namespace GridFramework.Renderers {
    ...
    public abstract class GridRenderer : MonoBehaviour {
        ...
        [SerializeField]
        private Color _colorX = new Color(1f, 0f, 0f, .5f);
        [SerializeField]
        private Color _colorY = new Color(0f, 1f, 0f, .5f);
        [SerializeField]
        private Color _colorZ = new Color(0f, 0f, 1f, .5f);
        ...
        /// <remarks>
        ///   <para>
        ///     The width of the rendered lines, if it is set to 1 all lines will
        ...
        ///     undefined, but guranteed to be fixed as long as there are no
        ///     renderers added.
        ///   </para>
        /// </remarks>
        public int Priority {
        ...
        ///     arrays are created and all vector set to (0, 0, 0).
        ///   </para>
        /// </remarks>
        protected void AllocatePoints() {
            for (var i = 0; i < 3; ++i) {
        ...
        /// <summary>
        ///   Computes the coordinates of the draw points.
        /// </summary>
        /// <remarks>
        ///   <para>
        ///     This is an abstract method, the implementations are up to the
        ///     subclasses. Call the method after the amount is known and the
        ///     <c>_lineSets</c> array is allocated.
        ///   </para>
        /// </remarks>
        protected abstract void ComputeLines();

        /// <summary>
        ///   Computes the amount of draw points.
        /// </summary>
        /// <remarks>
        ///   <para>
        ///     This is an abstract method, the implementations are up to the
        ///     subclasses. Despite its name, the amount is for the *lines* per
        ///     axis, not individual points (two per line). This method should be
        ///     called before the array is allocated. note that both <c>from</c>
        ///     and <c>to</c> are references, this allows us to convert them into a
        ///     common format that can be used in the subsequent calculations. For
        ///     example, absolute world dimensions could be converted to relative
        ///     grid dimensions and all other calculations would only need to be
