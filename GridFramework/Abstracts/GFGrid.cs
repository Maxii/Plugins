...
public abstract class GFGrid : MonoBehaviour {
    ...
    [SerializeField]
    private bool _relativeSize = true;

    ///<summary> Combined upper and lower rendering range bound. </summary>
    [SerializeField]
    protected Vector3 _size = 5.0f * Vector3.one;

    ///<summary> Lower rendering range bound. </summary>
    [SerializeField]
    protected Vector3 _renderFrom = -5 * Vector3.one;

    ///<summary> Upper rendering range bound. </summary>
    [SerializeField]
    protected Vector3 _renderTo = 5 * Vector3.one;
    #endregion
    ...
    [SerializeField]
    protected bool _useCustomRenderRange = true;
    ...
    /// <summary>Returns a List of Vector3 points in local space ready for use with Vectrosity.
    /// <remarks>Returns a list of Vector3 containing the points for a discrete vector
