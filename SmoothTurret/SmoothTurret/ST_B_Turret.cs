...
[HelpURL("http://mobfarmgames.weebly.com/mf_b_turret.html")]
public class ST_B_Turret : MF_AbstractPlatform {
	...
	[Split1(60)] public Vector2 restAngle;
	...
	public class AudioObject {
		...
		[Split1()] public float pitchMin = .75f;
		[Split2()] public float pitchMax = 1f;
	...
	public override void Awake () {
		...
		turnSpeed = rotationRate; // used by FS_Targeting to evaluate time to aim
